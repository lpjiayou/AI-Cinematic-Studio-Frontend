...
This is the complete class-separated index for governed Frontend documents.
Authority metadata is in the [Documentation Governance Policy](governance/DOCUMENTATION_GOVERNANCE_POLICY.md),
...
- [`CLAUDE.md`](../CLAUDE.md) — `ACTIVE`
- [`CONTRIBUTING.md`](../CONTRIBUTING.md) — `ACTIVE`
- [`docs/CREATOR_CORE_INTEGRATION.md`](CREATOR_CORE_INTEGRATION.md) — `ACTIVE`
- [`docs/design-system/ACS_BRAND_GUIDE.md`](design-system/ACS_BRAND_GUIDE.md) — `ACTIVE`
- [`docs/design-system/ACS_COMPONENT_GUIDE.md`](design-system/ACS_COMPONENT_GUIDE.md) — `ACTIVE`
- [`docs/design-system/ACS_LAYOUT_SYSTEM.md`](design-system/ACS_LAYOUT_SYSTEM.md) — `ACTIVE`
...
- [`prototype-spec/customer/02-workspace-home/PAGE_STRUCTURE.md`](../prototype-spec/customer/02-workspace-home/PAGE_STRUCTURE.md) — `ACTIVE`
...
- [`prototype-spec/customer/06-character-studio/DOMAIN_ALIGNMENT.md`](../prototype-spec/customer/06-character-studio/DOMAIN_ALIGNMENT.md) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/IMPLEMENTATION_CONTRACT.md`](../prototype-spec/customer/06-character-studio/IMPLEMENTATION_CONTRACT.md) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/INTERACTION_SPEC.md`](../prototype-spec/customer/06-character-studio/INTERACTION_SPEC.md) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/PAGE_STRUCTURE.md`](../prototype-spec/customer/06-character-studio/PAGE_STRUCTURE.md) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/RESPONSIVE_SPEC.md`](../prototype-spec/customer/06-character-studio/RESPONSIVE_SPEC.md) — `ACTIVE`
...
- [`prototype-spec/customer/06-character-studio/visual-spec/VISUAL_DIRECTION.md`](../prototype-spec/customer/06-character-studio/visual-spec/VISUAL_DIRECTION.md) — `ACTIVE`
...
- [`docs/status/FRONTEND_V3_WAVE_1C_ACCEPTANCE_2026-09-05.md`](status/FRONTEND_V3_WAVE_1C_ACCEPTANCE_2026-09-05.md) — `CURRENT`
- [`docs/status/FRONTEND_V3_WAVE_2A_ACCEPTANCE_2026-09-05.md`](status/FRONTEND_V3_WAVE_2A_ACCEPTANCE_2026-09-05.md) — `CURRENT`
- [`docs/status/FRONTEND_WORKSPACE_STATE_INTEGRITY_CLOSURE_2026-09-05.md`](status/FRONTEND_WORKSPACE_STATE_INTEGRITY_CLOSURE_2026-09-05.md) — `CURRENT`
- [`docs/status/FRONTEND_PRODUCTION_TRUTH_CLOSURE_2026-09-05.md`](status/FRONTEND_PRODUCTION_TRUTH_CLOSURE_2026-09-05.md) — `CURRENT`
...
- [`prototype-spec/customer/02-workspace-home/CODEX_VERIFY_PROMPT.txt`](../prototype-spec/customer/02-workspace-home/CODEX_VERIFY_PROMPT.txt) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/FREEZE_CHECKLIST.md`](../prototype-spec/customer/06-character-studio/FREEZE_CHECKLIST.md) — `ACTIVE`
- [`prototype-spec/customer/06-character-studio/IMPLEMENTATION_READINESS_CHECKLIST.md`](../prototype-spec/customer/06-character-studio/IMPLEMENTATION_READINESS_CHECKLIST.md) — `ACTIVE`

## IMPLEMENTATION_EVIDENCE

- [`design-qa.md`](../design-qa.md) — `RECORDED`
- [`public/assets/ai-director/ASSET_PROVENANCE.md`](../public/assets/ai-director/ASSET_PROVENANCE.md) — `RECORDED`
- [`public/assets/character-studio/ASSET_PROVENANCE.md`](../public/assets/character-studio/ASSET_PROVENANCE.md) — `RECORDED`
- [`public/assets/story-world/ASSET_PROVENANCE.md`](../public/assets/story-world/ASSET_PROVENANCE.md) — `RECORDED`
...
- [`governance/FRONTEND_GLOBAL_SHELL_REMEDIATION_CONTRACT_REV3.md`](../governance/FRONTEND_GLOBAL_SHELL_REMEDIATION_CONTRACT_REV3.md) — `HISTORICAL`
- [`governance/FRONTEND_IA_CORRECTION_CONTRACT.md`](../governance/FRONTEND_IA_CORRECTION_CONTRACT.md) — `HISTORICAL`
- [`governance/K2_G7_CONNECTED_PRODUCTION_WORKSPACE_CONTRACT.md`](../governance/K2_G7_CONNECTED_PRODUCTION_WORKSPACE_CONTRACT.md) — `HISTORICAL`
...
This index contains 101 governed Frontend documents. Registry
